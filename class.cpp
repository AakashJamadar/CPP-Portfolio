// Classes in C++ are user defined types declared with keyword class that has data and functions . Although 
...
// You have to create a class, named Student, representing the student's details, as mentioned above, and 
// store the data of a student. Create setter and getter functions for each element; that is, the class 
...
class Student{
    ...
    public:
        void set_age(int age) {
            this->age=age;    //use when the name of the parameter and attribute is same
        }
        ...
        string to_string(){
            ...
            string output=oss.str();  //declare stringstream to use oss>>output(used for extracting data)
            return output;
        }
};
